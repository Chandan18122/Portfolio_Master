                ...
                <div class="sidebar-height">
                    <div class="d-flex flex-column justify-content-between flex-shrink-0 p-3 bg-light h-100" style="width: 280px;">
                        ...
                        <ul class="nav nav-pills flex-column mb-auto">
                            <li class="nav-item">
                                <a href="std-9.php" class="nav-link" aria-current="page">
                            ...
                            <li>
                                <a href="scholarship.php" class="nav-link link-dark ">
                                    <svg class="bi me-2" width="16" height="16">
                                        <use xlink:href="#speedometer2"></use>
                                    </svg>
                                    scholarship
                            ...
                            <li>
                                <a href="students.php" class="nav-link link-dark active">
                                    <svg class="bi me-2" width="16" height="16">
                                        <use xlink:href="#speedometer2"></use>
                                    </svg>
                                    students
